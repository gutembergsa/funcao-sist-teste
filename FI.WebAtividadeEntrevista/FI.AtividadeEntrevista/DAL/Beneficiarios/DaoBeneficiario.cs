...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoBeneficiario : AcessoDados
    {
        ...
        internal List<Beneficiario> Pesquisa(int iniciarEm, int quantidade, string campoOrdenacao, bool crescente, int IDCLIENTE, out int qtd)
        {
        ...
        internal List<DML.Beneficiario> VerificarExistencia(string CPF)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
        ...
        internal bool VerificarExistencia(string CPF, bool overload)
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", CPF));
            DataSet ds = base.Consultar("FI_SP_VerificaBeneficiario", parametros);
